"""Canonical ACI-IoT trainer — writes sklearn_column_transformer_v1 bundles via save_bundle.

Serve path: deploy_api.py loads artifacts produced here. Legacy / experimental scripts
live under experiments/ and must not be used for release bundles.
"""
import numpy as np
import pandas as pd
